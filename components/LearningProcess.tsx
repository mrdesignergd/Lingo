  ...
  return (
    <section className="section advantages-section" id="about" aria-labelledby="advantages-title">
      ...
      <div className="container advantages-layout">
        <div className="advantages-heading"><span className="eyebrow">ПОЧЕМУ LINGO?</span><h2 id="advantages-title">С нами<br />эффективно<br />и комфортно</h2><span className="heading-stroke wide" aria-hidden="true" /></div>
